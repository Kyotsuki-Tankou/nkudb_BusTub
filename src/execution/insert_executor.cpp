...
auto InsertExecutor::Next([[maybe_unused]] Tuple *tuple, RID *rid) -> bool {
  ...
  //     auto new_rid=table_info_->table_->InsertTuple(inserted_tuple_meta, value_tuple,
  //     exec_ctx_->GetLockManager(),exec_ctx_->GetTransaction(), table_info_->oid_); if (new_rid == std::nullopt) {
  //         return false;
  //     }
  ...
  //       affected_index->index_->InsertEntry(child_tuple.KeyFromTuple(table_info_->schema_,
  //       affected_index->key_schema_,
